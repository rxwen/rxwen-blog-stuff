...
array=(ipset htop dsniff iftop openssh-server awesome awesome-extra gnome-settings-daemon realpath socat gpick gnupg2 silversearcher-ag shutter parcellite zsh fasd mpg123 ncurses-dev p7zip tofrodos check g++ cppcheck pylint mercurial git-core gitk tig git-svn valgrind cgdb python-pip python-markdown wireshark nmap vim-gnome ctags cscope expect flex doxygen graphviz pandoc goldendict sdcv dmenu manpages-posix-dev clang libclang-dev astyle global libc6-dev-i386)
