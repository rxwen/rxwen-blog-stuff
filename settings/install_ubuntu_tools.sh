...
array=(gpick gnupg2 shutter parcellite zsh fasd mpg123 ncurses-dev p7zip tofrodos check g++ cppcheck pylint mercurial git-core gitk tig git-svn valgrind cgdb python-pip wireshark nmap vim-gnome ctags cscope expect flex doxygen graphviz pandoc goldendict sdcv dmenu ant manpages-posix-dev clang libclang-dev astyle global libc6-dev-i386)
