...
setx PATH "%TOOLS_PATH%\apps;%TOOLS_PATH%\Python27;%TOOLS_PATH%\Python27\scripts;%TOOLS_PATH%\Debuggers\x64;%TOOLS_PATH%\nmap;%TOOLS_PATH%\GnuPG;%TOOLS_PATH%\graphviz\bin;%TOOLS_PATH%\java_sdk\bin;%TOOLS_PATH%\LLVM\bin;%TOOLS_PATH%\wireshark;%TOOLS_PATH%\pandoc;%TOOLS_PATH%\Sysinternals;%TOOLS_PATH%\Mercurial;%TOOLS_PATH%\gradle\bin;%TOOLS_PATH%\texlive\bin\win32;%TOOLS_PATH%\ruby\bin;%GOROOT_VARIABLE%\bin;%GOBIN%";%TOOLS_PATH%\android_sdk\tools;%TOOLS_PATH%\android_sdk\platform-tools;%TOOLS_PATH%\Git\cmd;%TOOLS_PATH%\cmake\bin\;%TOOLS_PATH%\doxygen\bin;%TOOLS_PATH%\putty\;
REM md %TOOLS_PATH%
